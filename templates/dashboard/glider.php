<li class="glide__slide "> 
  <div class="card ">
    <div class="card-body pt-1 pb-3">
      <h4 class="card-title border-bottom pb-1">Title</h4>
      <div class="card-content">
          <div class=" d-flex ">
            <div class=" d-flex flex-column align-self-start me-auto">
              <h5 class="fs-4 card-title ">Score</h5>
              <h6 class="fs-14 card-title">Target</h6>
            </div>
            <div class="card-icon d-flex align-self-center ">
          ...
          </div><!--FLEX BOX ENDS HERE-->
          <div class="progress w-100">
            <div class="progress-bar bg-dark" role="progressbar" style="width: 75%;" aria-valuenow="75" aria-valuemin="0" aria-valuemax="100">75% complete</div>
          </div>
      </div>
    </div>
  </div>
